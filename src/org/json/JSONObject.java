...
public class JSONObject {
	...
	/**
	 * Creates a new {@code JSONObject} by copying all name/value mappings from the
	 * given map.
	 *
	 * @param copyFrom a map whose keys are of type {@link String} and whose values
	 ...
	 *
	 * <p>
	 * Note that {@link #append(String, Object)} provides better semantics. In
	 ...
	 *                       {@code name} is non-null and is not a
	 *                       {@link JSONArray}.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a boolean or can
	 * be coerced to a boolean, or false otherwise.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a boolean or can
	 * be coerced to a boolean, or {@code fallback} otherwise.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a double or can
	 * be coerced to a double, or {@code NaN} otherwise.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a double or can
	 * be coerced to a double, or {@code fallback} otherwise.
	 */
	 ...
	 *
	 * @throws JSONException if the mapping doesn't exist or cannot be coerced to an
	 *                       int.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is an int or can be
	 * coerced to an int, or 0 otherwise.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is an int or can be
	 * coerced to an int, or {@code fallback} otherwise.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a long or can be
	 * coerced to a long, or 0 otherwise. Note that JSON represents numbers as
	 * doubles, so this is <a href="#lossy">lossy</a>; use strings to transfer
	 * numbers via JSON.
	 */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a long or can be
	 * coerced to a long, or {@code fallback} otherwise. Note that JSON represents
	 ...
	 * iterator is returned, the iterator's behavior is undefined. The order of the
	 * keys is undefined.
	 */
	 ...
	 * or {@code Collection}, returns an equivalent {@code JSONArray}. If the object
	 * is a {@code Map}, returns an equivalent {@code JSONObject}. If the object is
	 * a primitive wrapper type or {@code String}, returns the object. Otherwise if
	 * the object is from a {@code java} package, returns the result of
