...
public class JSONArray {
	 ...
	 *              Integer, Long, Double, {@link JSONObject#NULL}, or {@code null}.
	 *              May not be {@link Double#isNaN() NaNs} or
	 *              {@link Double#isInfinite() infinities}. Unsupported values are
	 *              not permitted and will cause the array to be in an inconsistent
	 *              state.
	 * @return this array.
	 */
	 ...
	 *
	 * @throws JSONException if this array has no value at {@code index}, or if that
	 *                       value is the {@code null} reference. This method
	 *                       returns normally if the value is
	 *                       {@code JSONObject#NULL}.
	 */
	 ...
	 * strings will be coerced to strings. This method returns null if either array
	 * is empty.
	 */
